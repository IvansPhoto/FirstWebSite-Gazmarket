...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageBtnPrev:			'/img/NavPrevious.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/img/NavNext.gif',			// (string) Path and the name of the next button image
			...
			<div id="jquery-lightbox">
				<div id="lightbox-container-image-box">
					<div id="lightbox-container-image">
						<img src="/img/XX.jpg" id="lightbox-image">
						<div id="lightbox-nav">
